                  ...
                  <li>
                    <form className="flex items-center">
                      ...
                      <div className="relative w-full">
                        ...
                        <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-skyblues-500 focus:border-skyblues-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-skyblues-500 dark:focus:border-skyblues-500" placeholder="Search Project name..." required />
                      </div>
                    </form>
                  </li>
                </ul>
